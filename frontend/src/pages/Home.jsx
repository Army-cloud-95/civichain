    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-2xl font-bold text-gray-900 mb-1">50,324</div>
            ...
            <div className="text-center">
              ...
              <div className="text-2xl font-bold text-gray-900 mb-1">7,532</div>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center mb-3">
                <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                  <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 7h2l1 10a2 2 0 002 2h8a2 2 0 002-2l1-10h2M5 7h14M10 11v6m4-6v6" />
                  </svg>
                </div>
              </div>
              <div className="text-2xl font-bold text-gray-900 mb-1">1,245</div>
              <p className="text-sm text-gray-600">Departments Engaged</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-10 rounded-3xl shadow-md hover:shadow-lg transition-shadow cursor-pointer border border-gray-100">
              ...
              <p className="text-base text-gray-500">25,430 issues</p>
            </div>
            ...
            <div className="bg-white p-10 rounded-3xl shadow-md hover:shadow-lg transition-shadow cursor-pointer border border-gray-100">
              ...
              <p className="text-base text-gray-500">18,250 issues</p>
            </div>
            ...
            <div className="bg-white p-10 rounded-3xl shadow-md hover:shadow-lg transition-shadow cursor-pointer border border-gray-100">
              ...
              <p className="text-base text-gray-500">12,890 issues</p>
            </div>
            ...
            <div className="bg-white p-10 rounded-3xl shadow-md hover:shadow-lg transition-shadow cursor-pointer border border-gray-100">
              ...
              <p className="text-base text-gray-500">15,670 issues</p>
            </div>
            ...
            {[1, 2, 3, 4, 5, 6].map((item) => (
              ...
              >
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Large pothole causing traffic issues on Main Street near the
                  shopping center...
                </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto">
              A simple, transparent flow to participate – styled cleanly in blue
              & white.
            </p>
          </div>

          {/* Steps */}
          <div className="relative flex flex-col md:flex-row md:items-stretch md:justify-between gap-12 md:gap-16">
            {[
              {
                title: "Report Issues",
              ...
              >
                ...
                {i < arr.length - 1 && (
                  <div className="hidden md:block absolute top-1/2 right-0 translate-x-1/2 -translate-y-1/2 w-40 lg:w-48 h-40 pointer-events-none z-0">
                    <svg
                      viewBox="0 0 200 160"
                    ...
                    >
                      <path
                        d="M0 120 C60 20 140 20 200 120"
                        stroke="#60A5FA"
                        strokeWidth="3"
                        strokeDasharray="8 8"
                        strokeLinecap="round"
      ...
      <section className="py-24 bg-white">
        <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto">
              Join CiviChain today and start reporting issues, engaging with
              your neighbors, and making a real impact in your area.
            </p>
          </div>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 p-10 flex flex-col justify-between">
              <div>
                ...
                <p className="text-gray-600 mb-6 max-w-sm">See something that needs fixing? Submit detailed civic issues with photos and location to alert the community.</p>
              </div>
              <Link to="/report" className="inline-flex items-center bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors text-sm">Report Now →</Link>
              <div className="absolute right-0 bottom-0 opacity-10 text-[180px] leading-none select-none pointer-events-none font-bold pr-4">!</div>
            </div>
            <div className="flex-1 relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 to-blue-700 p-10 flex flex-col justify-between text-white">
              <div>
                <h3 className="text-2xl font-bold mb-4">Explore Community Feed</h3>
                <p className="text-blue-100 mb-6 max-w-sm">Discover, upvote and follow issues that matter most to your area. Help drive priority with collective visibility.</p>
              </div>
              <Link to="/feed" className="inline-flex items-center bg-white text-blue-600 px-6 py-3 rounded-lg font-medium hover:bg-blue-50 transition-colors text-sm">Browse Feed →</Link>
              <div className="absolute right-0 -bottom-8 opacity-20 text-[150px] leading-none select-none pointer-events-none font-bold pr-4">∞</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Making communities better through blockchain-powered civic
                engagement and transparent issue reporting.
              </p>
            </div>
